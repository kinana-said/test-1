...
Route::middleware('auth:sanctum')->group(function(){
    ...
    Route::get('/portfolios/{portfolio_id}/sections/{section_id}', [SectionController::class,"show"]);
    ...
    Route::get('/portfolios/{portfolio_id}/contacts/{contact_id}', [ContactController::class,"show"]);
    ...
    Route::get('/portfolios/{portfolio_id}/works/{works_id}', [WorkController::class,"show"]);
